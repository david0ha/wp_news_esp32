...
/* Everything the header reports that is about the board rather than the news.
...
/* The rectangle that can change without new news data, in panel coordinates.
 *
