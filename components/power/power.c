...
#ifndef CONFIG_CLAUDEPOST_SLEEP_SECONDS
#define CONFIG_CLAUDEPOST_SLEEP_SECONDS 900
#endif
#ifndef CONFIG_CLAUDEPOST_AWAKE_WINDOW_SECONDS
#define CONFIG_CLAUDEPOST_AWAKE_WINDOW_SECONDS 120
#endif
...
{
#ifdef CONFIG_CLAUDEPOST_DEEP_SLEEP
    return true;
#else
    return false;
#endif
...
{
    return (uint32_t)CONFIG_CLAUDEPOST_SLEEP_SECONDS;
}

uint32_t power_awake_window_seconds(void)
{
    return (uint32_t)CONFIG_CLAUDEPOST_AWAKE_WINDOW_SECONDS;
}
