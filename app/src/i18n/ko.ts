...
export const ko: Strings = {
  ...
  settings: {
    ...
    news: {
      ...
      saved: {
        deskOk: '저장했습니다. 데스크가 응답했습니다 — {edition}.',
        deskOkPlain: '저장했습니다. 데스크가 응답했고, 오늘 탭이 이 주소를 읽습니다.',
        deskFailed: '저장했지만, 그 주소에서 에디션을 읽지 못했습니다. {detail}',
        fetching: '보드가 새 주소를 받아 지금 읽고 있습니다.',
        clearedDemo: '비웠습니다. 보드는 다시 데모 데이터를 사용합니다.',
        todayOnly: '이 휴대폰에는 아직 보드가 없습니다. 나중에 설정하는 보드도 같은 주소를 받습니다.',
        clearedTodayDemo: '비웠습니다. 오늘 탭은 데모 에디션을 표시합니다.',
        noClient: '지금은 보드와 연결되어 있지 않아, 앱이 보드에 닿는 대로 전송됩니다.',
        boardAsleep: '보드가 절전 중이라, 앱이 다음에 보드에 닿을 때 새 주소를 받습니다.',
        boardBusy: '보드가 지금은 받지 않았고, 앱이 다음에 보드에 닿을 때 새 주소를 받습니다.',
      },
    },
    connection: {
  ...
  errors: {
    ...
    market: {
      ...
      crumb: '데스크가 지금은 상세 데이터를 가져오지 못합니다. 가격과 뉴스는 그대로 표시됩니다.',
      parse: 'Yahoo가 이 앱이 이해하지 못하는 응답을 보냈습니다.',
      notFound: '해당 종목의 데이터가 없습니다.',
      noDesk: '설정에서 데스크 주소와 토큰을 입력하면 볼 수 있습니다.',
  ...
  board: {
    deskPreview: {
      title: '보드에 표시될 지면',
      note: '서버에 현재 발행된 지면입니다. 보드가 다음에 연결되면 받을 지면이며, 실제 보드에 표시된 화면을 확인한 것은 아닙니다.',
      loading: '발행된 지면을 불러오는 중…',
      setup: '설정에서 서버 주소와 운영자 토큰을 저장하면 보드 지면을 미리 볼 수 있습니다.',
      empty: '아직 미리 볼 수 있는 발행 지면이 없습니다.',
      failed: '발행된 지면을 불러오지 못했습니다. 서버 연결을 확인하고 다시 시도해 주세요.',
      imageFailed: '지면 이미지를 받지 못했습니다. 다시 시도해 주세요.',
      enlarge: '지면 확대',
      refresh: '프리뷰 새로고침',
      close: '닫기',
      zoom: '두 손가락으로 지면을 확대할 수 있습니다.',
    },
    connecting: '연결 중…',
    loading: '불러오는 중…',
  ...
  marketDetail: {
    ...
    options: {
      unsupportedDeliverable: '계약 규모를 확인할 수 없거나 표준 100주 계약이 아니어서 총액과 만기 손익을 계산할 수 없습니다.',

      strategyTotal: '전략 총 프리미엄',
      netBid: '주당 순매수호가',
      netAsk: '주당 순매도호가',
      comparePairs: '선택한 행사가와 각 조합을 비교하세요. 프리미엄과 그릭스는 순합계입니다. 프리미엄의 양수는 지급, 음수는 수취를 뜻합니다. 선택한 행사가를 다시 누르면 초기화됩니다.',

      long_call: '콜',
      long_put: '풋',
      long_call_spread: '롱콜 스프레드',
      short_call_spread: '숏콜 스프레드',
      long_put_spread: '롱풋 스프레드',
      short_put_spread: '숏풋 스프레드',
      premium: '주당 프리미엄',
      contractTotal: '계약당 프리미엄',
      buy: '매수',
      sell: '매도',
      bid: '매수호가',
      ask: '매도호가',
      ...
      vega: '베가',
      rho: '로',
      selectTwo: '서로 다른 행사가 두 개를 선택하세요. 목록 프리미엄은 개별 계약의 매수 비용(매도호가)입니다.',
      selectOne: '행사가를 선택하면 손익과 계약 상세를 볼 수 있어요.',
      selectedStrike: '선택한 행사가',
      detailTitle: '전략 상세',
      breakEven: '손익분기점',
      maxProfit: '최대수익',
      maxLoss: '최대손실',
      ...
      credit: '수취',
      unlimited: '무제한',
      entryPremium: '주당 진입 프리미엄 (지급 +, 수취 −)',
      entryHint: '매수는 매도호가, 매도는 매수호가로 진입 비용을 추정합니다. 프리미엄을 수정해 비교하세요. 체결을 보장하지 않습니다.',
      payoffTitle: '만기 시 손익',
      payoffNote: '각 레그당 표준 100주 계약 1개 기준 · USD · 수수료 제외. 각 계약이 만기 정산된다고 가정하며 조기 행사·배정 시 실제 손익은 달라질 수 있습니다.',
      quoteTime: '호가 시각',
      tradeTime: '체결 시각',
      indicative: 'Alpaca · 참고 시세 (실시간 OPRA 체결 가능 호가 아님)',
      opra: 'Alpaca · OPRA 시세',
      unknownFeed: 'Alpaca · 피드 정보 없음',
      closeDetail: '상세 닫기',
      refresh: '호가 새로고침',
      volume: '거래량',
      openInterest: '미결제약정',
