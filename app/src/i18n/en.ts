...
export const en = {
  ...
  marketDetail: {
    ...
    options: {
      unsupportedDeliverable: 'Contract size is unverified or is not the standard 100 shares, so totals and expiration payoff are unavailable.',

      strategyTotal: 'Premium / strategy',
      netBid: 'Net bid / share',
      netAsk: 'Net ask / share',
      comparePairs: 'Compare each pair with the selected strike. Premiums and Greeks are net. A positive premium is paid; a negative premium is received. Tap the selected strike to reset.',
      ...
      contractTotal: 'Premium / contract',
      buy: 'Buy',
      sell: 'Sell',
      bid: 'Bid',
      ask: 'Ask',
      ...
      vega: 'Vega',
      rho: 'Rho',
      selectTwo: 'Select two different strikes for a spread. Listed premiums are buy asks per leg.',
      selectOne: 'Select a strike for payoff and contract details.',
      ...
      credit: 'Receive',
      unlimited: 'Unlimited',
      entryPremium: 'Entry premium / share (debit +, credit −)',
      entryHint: 'Entry estimate uses buy asks and sell bids. Enter a signed premium to model your entry; fills are not guaranteed.',
      payoffTitle: 'Profit / loss at expiration',
      payoffNote: 'One standard 100-share contract per leg. USD, before fees. Assumes each leg settles at expiration; early exercise or assignment can change realized results.',
      quoteTime: 'Quote time',
      tradeTime: 'Trade time',
      indicative: 'Alpaca · Indicative quotes (not executable real-time OPRA quotes)',
      opra: 'Alpaca · OPRA',
      unknownFeed: 'Alpaca · Feed unavailable',
